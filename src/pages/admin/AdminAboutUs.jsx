...
const AdminAboutUs = () => {
  const [fields, setFields] = useState([
    ...
    { id: 'email', label: 'email', value: 'contact@movieverse.com', isLong: false, status: true },
    { id: 'website', label: 'website', value: 'https://movieverse.com', isLong: false, status: true },
    { id: 'contact', label: 'contact', value: '+1 (555) 123-4567 (9 AM to 5 PM)', isLong: false, status: true },
    { id: 'about_us', label: 'about_us', value: 'MovieVerse is a premium streaming destination dedicated to providing the finest range of cinematic content across all categories.', isLong: true, status: true },
  ]);
